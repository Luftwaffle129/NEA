...
namespace NEALibrarySystem.ListViewHandlers.SelectedItems
{
    ...
    /// </summary
    public class zCirculationObjectHandler
    {
        ...
        public zCirculationObjectHandler(TextBox memberBarcode, TextBox memberName, TextBox loans, TextBox overdue, TextBox lateFees,TextBox enterBarcode, ListView lsv, bool priceNeeded)
        {
            // set up listview
            _selectedBooks = lsv;
